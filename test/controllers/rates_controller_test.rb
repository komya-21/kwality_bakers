...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { price: @rate.price, product_id: @rate.product_id, ptype: @rate.ptype } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { price: @rate.price, product_id: @rate.product_id, ptype: @rate.ptype } }
